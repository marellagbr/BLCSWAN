...
$hashedPassword = "982447403f9bfb06343c0e6cd0d848d2"; 
    ...
    <body class="bg-gray-900 flex items-center justify-center h-screen">
        <div class="bg-gray-800 p-6 rounded-xl shadow-xl w-full max-w-md text-white">
            ...
            <form method="POST" class="space-y-4">
                ...
                <?php endif; ?>
                <input type="password" name="password" placeholder="Ð¼Ð¸Ñ€ Ð²Ñ€ÐµÐ¼ÐµÐ½ÐµÐ½" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 rounded focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                <button type="submit" name="login" class="w-full bg-blue-500 hover:bg-blue-600 text-white py-2 rounded font-semibold">
                    <i class="fas fa-sign-in-alt mr-1"></i> è®°ä½ç½ªæ¶
                </button>
            </form>
            <p class="mt-4 text-center text-sm text-gray-500">ØªØ°ÙƒØ± Ø§Ù„Ø®Ø·ÙŠØ¦Ø©</p>
        </div>
